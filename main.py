    ...
    try:
        ...
        try:
            analysis_response = openai.ChatCompletion.create(
                model="ft:gpt-4o-mini-2024-07-18:trmh::B5CETwIZ",
                messages=[
                    {"role": "system", "content": "You are TerraBot, an empathetic and resourceful assistant that provides guidance, insights, and recommendations"
                                                    "related to land surveying, land processing, and land ownership."
